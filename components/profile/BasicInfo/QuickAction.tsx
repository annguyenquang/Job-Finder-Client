...
const QuickAction: React.FC = () => {
  ...
  const handleExpandedChange = (_: React.SyntheticEvent<Element, Event>, expanded: boolean) => {
            ...
            >
              ...
              <AccordionDetails>
                ...
                <Button
                  ...
                  endIcon={<NavigateNext></NavigateNext>}
                >
                  Portfolio, file đính kèm và liên kết mạng xã hội{' '}
                </Button>
                <Button
                  sx={{ textTransform: 'none', textAlign: 'start' }}
                  startIcon={<Add></Add>}
                ...
                <Button
                  ...
                  endIcon={<NavigateNext></NavigateNext>}
                >
                  Hoạt động ngoại khóa hoặc tình nguyện
                </Button>
              </AccordionDetails>
            </Accordion>
          </Paper>
