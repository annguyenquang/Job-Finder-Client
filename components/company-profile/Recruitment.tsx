...
import { CompanyDetail, Job } from '@/models'
    ...
    <Card className='flex flex-col mb-4'>
      ...
      <CardContent>
        <Grid2 container spacing={3}>
          <Grid2 size={5}>
            <TextField id='outlined-basic' label='Tên công việc, vị trí ứng tuyển...' fullWidth variant='outlined' />
          </Grid2>
          <Grid2 size={4}>
                ...
                <CardContent>
                  <Box key={job.id}>
                    <Grid2 spacing={3} container>
                      ...
                      >
                        <Avatar alt='avatar' src={company.avatar} className='border-4 w-20 h-20 border-white' />
                      </Grid2>
                      <Grid2 size={7}>
