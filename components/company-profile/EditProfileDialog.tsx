...
export const EditProfileDialog: React.FC<EditProfileDialogProps> = (props: EditProfileDialogProps) => {
    ...
    React.useEffect(() => {
        ...
        setInputProvinceText(locationStore.allProvince.find((province) => province.code === editCompanyStore.company.provinceId)?.name || '');
    }, [editCompanyStore.company.provinceId, locationStore.allProvince]);

    React.useEffect(() => {
        console.log("inputProvinceText: ", inputProvinceText);
        console.log("provinceId: ", editCompanyStore.company.provinceId);
        console.log("AllProvince: ", locationStore.allProvince);

    }, [inputProvinceText, editCompanyStore.company.provinceId, locationStore.allProvince]);
        ...
        <Box>
            ...
            >
                ...
                <DialogContent dividers>
                    <Box
                        className="flex flex-row justify-around mb-4"
                    >
                        <Box>
                            <Typography
                                className='font-semibold font-sans text-base mb-2'
                            >
                                Tên công ty:
                            </Typography>
                    ...
                    <Box
                        className="flex flex-row ml-12 mb-4"
                    >
                        <Box>
                            <Typography
                                className='font-semibold font-sans text-base mb-2'
                    ...
                    <Box
                        className="ml-11"
                    >
                        <Typography className='font-semibold font-sans text-base ml-1 pb-4'>
                            Địa điểm làm việc:
                        </Typography>
                        ...
                        <Box className="flex flex-row">
                            {
                                ...
                                <Autocomplete
                                    ...
                                    value={locationStore.allProvince.find((province) => province.code === editCompanyStore.company.provinceId)}
                    ...
                    <Box
                        className="pb-2 pl-11 pr-11"
                    >
                        <Typography className='font-semibold font-sans text-base ml-1'>
                            Giới thiệu công ty:
                        </Typography>
                        <ReactQuill
                            theme="snow"
