  ...
  return (
    <Card className='mb-4'>
      <Box className='p-2 flex-row flex'>
        <Typography className='font-semibold font-sans text-lg pl-2 pt-2 pb-2'>Yêu cầu công việc</Typography>
        <Typography className='font-semibold font-sans text-red-600 text-xl pt-2'>*</Typography>
      </Box>
      <Divider variant='fullWidth' />
      <Box className='p-2'>
        <Box>
          <Typography className='font-semibold font-sans text-base pl-2 pt-2'>Giới tính</Typography>
        ...
        <Box>
          <Typography className='font-semibold font-sans text-base pl-2 pt-2 pb-2'>Tuổi</Typography>

          <Box className='mr-1'>
            <Typography className='text-sm font-sans pl-2 pb-1'>Tối thiểu</Typography>
            <TextField
              id='min-age'
              size='small'
              variant='outlined'
          ...
          <Box>
            <Typography className='text-sm font-sans pl-2 pb-1'>Tối đa</Typography>
            <TextField
              id='max-age'
              size='small'
              variant='outlined'
        ...
        <Box>
          <Typography className='text-sm font-sans pl-2 pb-4'>Kỹ năng yêu cầu</Typography>
        ...
        <Box>
          <Typography className='text-sm font-sans pl-2 pb-1'>Yêu cầu trình độ học vấn tối thiểu</Typography>
          ...
          >
            ...
            >
              ...
              {metadataStore.listEducationLevel.length > 0 &&
                metadataStore.listEducationLevel.map((metadata) => (
                  <MenuItem
                    key={metadata.id}
                    value={metadata.id}
                  >
        ...
        <Box>
          <Typography className='text-sm font-sans pl-2 pb-1'>Yêu cầu kinh nghiệm</Typography>
          ...
          >
            ...
            >
              ...
              {metadataStore.listWorkExperience.length > 0 &&
                metadataStore.listWorkExperience.map((metadata) => (
                  <MenuItem
                    key={metadata.id}
                    value={metadata.id}
                  >
        ...
        <Box>
          <Typography className='text-sm font-sans pl-2 pb-4'>Ngày đóng</Typography>
