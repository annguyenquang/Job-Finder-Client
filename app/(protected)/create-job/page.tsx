  ...
  return (
    <Box className='flex flex-col bg-colorLittleWhite'>
      <Box className='bg-white shadow-md'>
        ...
        >
          <Typography
            className='font-semibold font-sans p-4'
            variant='h6'
          >
            Đăng Tin Tuyển Dụng
          </Typography>
      ...
      <Container
        maxWidth='sm'
        className='flex-grow mt-4 mb-16'
      >
        <TitleCard />
        <AddressCard />
        <DescriptionCard />
      ...
      <Box className='bg-white shadow fixed bottom-0 left-0 right-0 z-10'>
        ...
        >
          <Box className='flex flex-row'>
            ...
            <Typography className='font-semibold text-yellow-700 text-lg font-sans'>Bản nháp</Typography>
          </Box>
