...
const fakeJobs: Job[] = [
    ...
    },
    {
        ...
        position: 'TP. Hồ Chí Minh', // Vị trí: TP. Hồ Chí Minh
        status: JobStatus.Open,
    ...
    },
    {
        ...
        position: 'Đà Nẵng', // Vị trí: Đà Nẵng
    ...
    },
    {
        ...
        position: 'Hải Phòng', // Vị trí: Hải Phòng
        status: JobStatus.Open,
    ...
    },
    {
        ...
        position: 'Bình Dương', // Vị trí: Bình Dương
        status: JobStatus.Open,
...
const getJobs = async (ownerId: string): Promise<JobResponse | undefined> => {
    try {
